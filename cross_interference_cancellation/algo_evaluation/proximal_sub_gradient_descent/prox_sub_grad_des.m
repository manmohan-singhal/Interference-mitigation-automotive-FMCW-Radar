function [delta_X] = prox_sub_grad_des(X,lambda,initial_step_size,limit,maxIter)
...
plot(delta_X_relchange_vec,'MarkerSize',5,'Marker','diamond','MarkerIndices',[5:5:100],'LineWidth',2);
hold on
legend('SIR = -60 dB, percentage of interference = 2.34','SIR = -53.98 dB, percentage of interference = 2.38','SIR = -60 dB, percentage of interference = 4.68','SIR = -53.98 dB, percentage of interference = 4.68')
xlabel('Iteration count','FontSize',18)
ylabel('Relative euclidean distance ','FontSize',18)
